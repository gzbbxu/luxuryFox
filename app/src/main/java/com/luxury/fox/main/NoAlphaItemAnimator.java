...
public class NoAlphaItemAnimator extends SimpleItemAnimator {
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.setListener(new VpaListenerAdapter() {//update zkk
                @Override
                public void onAnimationStart(View view) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(getChangeDuration()).
                    setListener(new VpaListenerAdapter() {//update  zkk
                @Override
                public void onAnimationStart(View view) {
...
//        AnimatorCompatHelper.clearInterpolator(holder.itemView);
     ...
     * then NoAlphaItemAnimator will call {@link #animateMove(ViewHolder, int, int, int, int)} and
